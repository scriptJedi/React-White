...
// import '../assets/PrivacyPolicy.css'; // Создайте файл стилей и импортируйте его
...
const PrivacyPolicy = () => {
    ...
    return (
        <div>
            <h1>Privacy Policy of {siteInfo.companyName}</h1>
            <p>
                {siteInfo.companyName} operates the {siteInfo.websiteName}, which provides the SERVICE.
            </p>
            <p>
                This page is used to inform website visitors regarding our policies with the collection, use, and
                disclosure of Personal Information if anyone decided to use our Service, the {siteInfo.websiteName}.
            </p>
            <p>
