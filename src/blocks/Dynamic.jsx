          ...
          <div className="dynamic-ya-block">
            <div className="dynamic-ya-block__item">
              <div className="dynamic-ya-block__icon">
                <CircleIcon iconName="faObjectUngroup" />
              </div>
            ...
            <div className="dynamic-ya-block__item">
              <div className="dynamic-ya-block__icon">
                <CircleIcon iconName="faChartLine" />
              </div>
            ...
            <div className="dynamic-ya-block__item">
              <div className="dynamic-ya-block__icon">
                <CircleIcon iconName="faChartSimple" />
              </div>
            ...
            <div className="dynamic-ya-block__item">
              <div className="dynamic-ya-block__icon">
                <CircleIcon iconName="faChartPie" />
              </div>
            ...
            <div className="dynamic-ya-block__item">
              <div className="dynamic-ya-block__icon">
                <CircleIcon iconName="faCameraRetro" />
              </div>
