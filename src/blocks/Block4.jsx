import "../assets/styles/Block4.css";
        ...
        <div className="coin-wrap">
          ...
          <div className="coin-block">
            ...
            <div className="coin-item">
              ...
              <h4 className="coin-item-title">Easy customize</h4>
              <p className="coin-descr">
            ...
            <div className="coin-item">
              <div className="coin-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path d="M14,9H10a1,1,0,0,0-1,1V22a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V10A1,1,0,0,0,14,9ZM13,21H11V11h2ZM22,1H18a1,1,0,0,0-1,1V22a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V2A1,1,0,0,0,22,1ZM21,21H19V3h2ZM6,15H2a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1H6a1,1,0,0,0,1-1V16A1,1,0,0,0,6,15ZM5,21H3V17H5Z"></path>
                </svg>
              </div>
              <h4 className="coin-item-title">Clean code</h4>
              <p className="coin-descr">
            ...
            <div className="coin-item">
              ...
              <h4 className="coin-item-title">Fully responsive</h4>
              <p className="coin-descr">
            ...
            <div className="coin-item">
              ...
              <h4 className="coin-item-title">Color scheme</h4>
              <p className="coin-descr">
                It to make a type specimen book. It has survived not only five
                centuries, but also the leap into electronic typesetting,
                remaining essentially unchanged.
            ...
            <div className="coin-item">
              <div className="coin-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path d="M22,17H2a1,1,0,0,0,0,2H22a1,1,0,0,0,0-2Zm0,4H2a1,1,0,0,0,0,2H22a1,1,0,0,0,0-2ZM6,7A1,1,0,1,0,7,8,1,1,0,0,0,6,7ZM20,1H4A3,3,0,0,0,1,4v8a3,3,0,0,0,3,3H20a3,3,0,0,0,3-3V4A3,3,0,0,0,20,1Zm1,11a1,1,0,0,1-1,1H4a1,1,0,0,1-1-1V4A1,1,0,0,1,4,3H20a1,1,0,0,1,1,1ZM12,5a3,3,0,1,0,3,3A3,3,0,0,0,12,5Zm0,4a1,1,0,1,1,1-1A1,1,0,0,1,12,9Zm6-2a1,1,0,1,0,1,1A1,1,0,0,0,18,7Z"></path>
                </svg>
              </div>
              <h4 className="coin-item-title">Excellent purchase</h4>
              <p className="coin-descr">
                Various versions have evolved over the years, sometimes by
                accident, sometimes on purpose.
              </p>
